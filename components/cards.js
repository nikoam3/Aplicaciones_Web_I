                ...
                render.innerHTML += `<div class="col">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <p class="card-text text-center">$<strong class="precioArticulo">${card[i].precio}</strong></p>
                                            </div>
                                            <div class="card-footer text-center">
                                                <input type="number" class="form-control" placeholder="0" value="0"></input>
                                                <button id="botonAgreCarro" type="button" class="btn btn-outline-success m-3"><i
